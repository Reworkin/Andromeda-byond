# Руководство по локализации проекта A13

Руководство описывает стандарты локализации и работы с текстом на русском языке в проекте [A13](https://github.com/Reworkin/Andromeda-13.git). Его основная цель — обеспечить единство и согласованность текстов внутри проекта, а также упростить процесс проведения ревью.
...
1. [DeepSeek](https://chat.deepseek.com)
   ...
   Билд А13 — это буквально работа двух, что делят один мозг, это [Rewokin и DeepSeek](/.github/images/memes/Rewokin_and_DeepSeek.png)
